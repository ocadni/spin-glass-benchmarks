...
def global_annealing( J, pop_size, num_steps_MC, swap_step, N, Tstart, Tend, Observables,
    ...
    for i in range(high_temp_thermalization_steps):
        population = monte_carlo_update_fast(population, J, beta=1/oldT)
    ...
    for currT in temperatures[1:-1]:
        ...
        for i in range(num_steps_MC):
            ...
            for j in range(swap_step):
                population = monte_carlo_update_fast(population, J, 1/currT)
...
if __name__ == "__main__":
    ...
    parser.add_argument('--MCsteps', type=int, default=200, help='Number of Monte Carlo steps for each MLMC step')
    ...
    temperatures, observ, elapsed_time = global_annealing( J, pop_size, MLMCsteps, MCsteps,N,  Tstart,
