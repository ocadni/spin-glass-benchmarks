...
path = 'C:/Users/acer/Desktop/stage_M1/MLMC_optimization_SK/Data/Alpha/Couplings/Configurations/'
...
if __name__ == "__main__":
    ...
    for k in range(len(txt_files)):
        start = 3  # position de 'N'
        end = txt_files[k].find("_", start) 
        N = int(txt_files[k][start+1:end])
        # .cuda() can be added to the following line
        J = read_couplings(f'C:/Users/acer/Desktop/stage_M1/MLMC_optimization_SK/Data/Alpha/Couplings/Configurations/{txt_files[k]}', N)
        with open(f'C:/Users/acer/Desktop/stage_M1/MLMC_optimization_SK/Data/Alpha/Couplings/Results/{txt_files[k][:3]+"sol_"+txt_files[k][3:]}') as f:
            lines = f.readlines()
        ...
        print(np.abs(minimum*N-energie)<1e-5)