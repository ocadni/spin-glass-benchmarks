...
def population_annealing(N, J, pop_size, num_steps_MC, Tstart, Tend, Observables, 
...
if __name__ == "__main__":
    ...
    parser.add_argument('--MCsteps', type=int, default=400, help='Number of Monte Carlo steps')
    ...
    #perform the simulated annealing
    temperatures, observ, elapsed_time = population_annealing(N, J, pop_size, MCsteps, Tstart, Tend, Observables, num_temps_determiner = num_temps_determiner, schedule=schedule)
