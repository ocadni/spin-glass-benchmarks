"""MADE (Masked Autoencoder for Distribution Estimation) model for spin glass sampling."""
...
def generate_config_fast(model: MADE, num_spins: int, num_configs: int, device: torch.device) -> torch.Tensor:
